...
def run_test_zero_changer():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    test2 = ([0, 4, 0, 0], [111, 7, 0, 1, 5, 0], [4, 4], [5, 0, 7])
    expected2 = ([1, 4, 2, 3], [111, 7, 4, 1, 5, 5], [4, 4], [5, 6, 7])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([], [0, 0, 0, 0, 0, 0], [1, 0, 4], [2, 0, 0])
    expected3 = ([], [1, 2, 3, 4, 5, 6], [1, 7, 4], [2, 8, 9])
    zero_changer(test3)
    print()
    print('Test 3:')
